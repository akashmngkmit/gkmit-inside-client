            ...
            >
              ...
              <AccordionContent className="px-6 pb-6 pt-0 text-base text-gray-700"> {/* Adjusted padding */}
                <p>
                  ...
                  is in a "Pending" state. Once an admin approves it, you will
                  be able to log in.
                </p>
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="px-6 pb-6 pt-0 text-base text-gray-700"> {/* Adjusted padding */}
                <p>
                  ...
                  reviewed. Your post is "Pending" and will appear on the main
                  feed as soon as an administrator approves it.
                </p>
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="px-6 pb-6 pt-0 text-base text-gray-700"> {/* Adjusted padding */}
                <p>
                  ...
                  and reviewing pending posts before they are published.
                </p>
              </AccordionContent>
            </AccordionItem>
